...
The data preparation of SODA is a little different from that of conventional object detection datasets, and it needs to split the original images first. Srcipts to obtain sub-images of SODA-D and SODA-A can be found at [SODA-mmdetection](https://github.com/shaunyuan22/SODA-mmdetection) and [SODA-mmrotate](https://github.com/shaunyuan22/SODA-mmrotate), respectively. More details about SODA please refer to the Dataset [Homepage](https://shaunyuan22.github.io/SODA/). 
